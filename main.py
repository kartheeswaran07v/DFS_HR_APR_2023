...
class RegistrationForm(FlaskForm):
    ...
    department_e = StringField(u"Department: ", validators=[DataRequired()])
    ...
    personal_mail = EmailField("Personal Mail ID: ", validators=[DataRequired()])
    address_home = StringField("Home Address (Country of Origin):", validators=[DataRequired()])
    passport_no = StringField("Passport No.: ", validators=[DataRequired()])
    nationality = StringField("Nationality: ", validators=[DataRequired()])
    own_car = BooleanField("Driving Own Car?: ")
    car_rent = BooleanField("Company Car:")
    company_laptop = StringField("Company Laptop Details: ", validators=[DataRequired()])
    company_mobile = StringField("Company Mobile Details: ", validators=[DataRequired()])
    e_uae_name = StringField("Name: ")
    e_uae_rel = StringField("Relationship: ")
    e_uae_addr = StringField("Address: ")
    e_uae_mob = IntegerField("Mobile No.:", validators=[DataRequired()])
    e_uae_hom = IntegerField("Home No.:", validators=[DataRequired()])
    ...
    e_co_mob = IntegerField("Mobile No.:", validators=[DataRequired()])
    e_co_hom = IntegerField("Home No.:", validators=[DataRequired()])
